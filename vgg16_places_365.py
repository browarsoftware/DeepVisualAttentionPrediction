...
WEIGHTS_PATH = 'models/Keras-Application-Zoo/releases/download/0.1/vgg16-places365_weights_tf_dim_ordering_tf_kernels.h5'
WEIGHTS_PATH_NO_TOP = 'models/Keras-Application-Zoo/releases/download/0.1/vgg16-places365_weights_tf_dim_ordering_tf_kernels_notop.h5'
